...
public class ForestDetector
{
    ...
    public ForestDetector(PlayerController playerController, Tilemap treeTilemap,int detectionRadius, Color vignetteColor)
    {
        ...
        coroutineRunner = playerController.CoroutineRunner;
    } 
